            ...
            message.guild.channels.create(`🎧｜Music`, {
                ...
                message.guild.channels.create(`🎷｜Requests`, {
                    ...
                    let dusra = new MessageEmbed()
                        ...
                        .setThumbnail(client.user.displayAvatarURL())
                        .setAuthor(message.author.username)
                        .setTitle("ᴀǫᴜᴀ ᴍᴜsɪᴄ- Best Free Music Bot of 2021")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[ INVITE ᴀǫᴜᴀ ᴍᴜsɪᴄ Music](https://discord.com/api/oauth2/authorize?client_id=883353218845908992&permissions=8&scope=bot) • [Join Server](https://discord.gg/T5qhFBwarX) • [Subscribe Now](https://www.youtube.com/channel/UClgxoz8QIf0-BbxTi5YwIPQ)`)
